package com.carlosjunior.mypong.constants;
...
public class PongConstants {
    ...
    public static final double BALL_MOV_X_INCREMENT_PERCENT = 0.5714;
    public static final double BALL_MOV_Y_INCREMENT_PERCENT = 0.4285;
    public static final double RACKET_MOV_X_INCREMENT_PERCENT = 0.5714;
    public static final int RACKET_MOV_Y_INCREMENT = 0;

    public static final int BALL_INITIAL_X_POSITION_PERCENT = 10;
    public static final int BALL_INITIAL_Y_POSITION_PERCENT = 20;
    public static final int BALL_RADIUS_PERCENT = 3;
